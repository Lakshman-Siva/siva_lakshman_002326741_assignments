...
public class Department {
    ...
    public Person addPerson(String id) {
        return persondirectory.newPerson(id);
    }
    ...
    public StudentProfile addStudent(Person p) {
        return studentdirectory.newStudentProfile(p);
    }

    public FacultyDirectory getFacultyDirectory() {
        return facultydirectory;
    }
    public FacultyProfile addFaculty(Person p) {
        return facultydirectory.newFacultyProfile(p);
    }
    
    public EmployerDirectory getEmployerDirectory() {
        return employerdirectory;
    }
    public EmployerProfile addEmployer(String name) {
        return employerdirectory.newEmployerProfile(name);
    }
